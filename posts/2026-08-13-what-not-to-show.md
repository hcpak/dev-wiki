...
그런데 빼고 나니 **이름이 안 맞았다.** "할 일 패널"이라고 불러왔는데 남은 건 링크와 파일이다. 할 일은 이제 안 보여준다. 그래서 이름도 바꿨다.

지금은 두 칸이다. 위에는 내가 꽂아둔 링크, 아래는 만들어낸 파일.

**보여주지 않기로 정하자 도구의 이름이 바뀌었다.** 무엇을 빼는지가 그 도구가 무엇인지를 정하고 있었던 셈이다.
