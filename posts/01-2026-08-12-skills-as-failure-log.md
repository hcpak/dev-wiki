...
AI 코딩 에이전트에게 반복 업무를 맡기기 시작한 지 몇 달이 지났다. 매번 같은 설명을 반복하는 게 싫어서, 자주 하는 작업들을 문서로 고정해두고 정해둔 문구를 입력하면 그 절차를 따라 일하게 하는 방식이다. 지금은 네 개가 돌아간다. 작업 기록 남기기, 이슈 트래커 기반 코드 작업, 패키지 배포와 검증, 주간 업무보고 초안 만들기.
...
실수를 막기 위한 규칙들이고, 전부 뒤에 사건이 하나씩 있다. 그래서 나는 규칙 옆에 **날짜와 사건을 같이 적어둔다.** "2026-07-31 실행에서 누락돼 6건이 빠졌다" 같은 식으로.
...
## 규칙을 더해도 직접 봐야 하는 일이 있었다

누락을 알리게 하는 규칙은 도움이 됐다. 그런데 공지와 댓글을 맡기면서는 다른 문제를 만났다.
...
지금은 채널 공지를 자동화에서 뺐다. 초안부터 내가 직접 쓴다.
...
내가 적어둔 규칙만으로는 이런 상황을 가려내기 어려웠다.

그래서 지금은 자동 모드로 돌리더라도 **댓글과 본문 수정만은 무조건 초안을 보여주고 승인을 받게** 해뒀다. 나머지는 알아서 하되 이건 예외다.

---

## 관련 있는 말이어도 할 자리는 따로 있었다

두 사례를 나란히 놓고 보니 뿌리가 같았다.

AI는 **글의 내용**은 잘 읽는다. 이 이슈가 저 이슈와 관련 있다는 건 나보다 빨리 찾는다. 그런데 내가 맡겼을 때는 **그 자리의 성격**을 놓치는 일이 있었다. 여기가 누구의 공간인지, 지금 이 대화가 어떤 흐름인지, 이 말을 여기서 하면 누가 불편해지는지.

그런 맥락은 내가 준 문서에 충분히 담겨 있지 않았다. 팀에서 일하며 알게 된 관계와 대화 흐름을 규칙 몇 줄로 전달하기는 어려웠다.

그래서 지금 내 경계는 이렇게 정리됐다.

**조회와 초안 작성은 맡기고, 다른 사람에게 보낼 때는 내가 확인한다.**

![결과가 다른 사람에게 보이는 순간부터는 내가 본다](images/automation-boundary.png)

조회·수집·분석은 맡긴다. 채널 공지는 직접 쓰고, 댓글처럼 초안을 맡기는 경우에도 **다른 사람에게 보낼 때는 내가 확인한다.**
...
누락을 알리는 규칙은 같은 실수를 발견하는 데 도움이 됐다. 반면 어떤 말을 누구에게 언제 전할지는 여전히 내가 확인하고 있다.
