...
| 글 | 한 줄 | 발행 |
| --- | --- | --- |
| [자동화 문서를 계속 고치다 보니, 절차서가 아니라 사고 기록부가 되어 있었다](posts/2026-08-12-skills-as-failure-log.md) | AI에게 반복 업무를 맡기며 알게 된 것 — 문서의 가치는 절차가 아니라 금지 목록에 있었다 | [velog](https://velog.io/@hugh0703/skills-as-failure-log) |
