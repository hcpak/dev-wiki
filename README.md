...
| 2 | [일을 맡기면 대화가 막혔다 — 그래서 나눠 돌리기 시작했다](posts/02-2026-08-13-delegating-in-parallel.md) | 병렬 위임의 실제 — 실행은 병렬이 되는데 검토는 병렬이 안 된다 | (초안) |
| 3 | [상태를 보여주는 패널을 만들었더니, 무엇을 안 보여줄지가 일이 됐다](posts/03-2026-08-13-what-not-to-show.md) | 몇 줄짜리 화면에서 시간을 쓴 곳은 전부 "무엇을 뺄까"였다 | (초안) |
